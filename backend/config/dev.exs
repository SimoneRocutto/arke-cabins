...
config :backend, BackendWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "EcrAxdyh6wkeizkEwGeBy6JDvccPsoMuVTb9ZXJyY3aijM3BPOrLb8uT3N7x9tzC",
  watchers: []
...
config :arke_auth, ArkeAuth.Guardian,
       ...
       secret_key: "EcrAxdyh6wkeizkEwGeBy6JDvccPsoMuVTb9ZXJyY3aijM3BPOrLb8uT3N7x9tzC"
